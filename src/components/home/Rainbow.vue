...
function renderChart() {
  chart = init(document.getElementById("rainbow"))

  const option = {
    color: ["#125ec1", "#3fa5c0", "#d68839", "#ad5b68", "#6082a5"],
    series: [
      {
        name: "金融类",
        type: "pie",
...
<template>
  <div class="wrap-container container">
    <div class="content">
      <div class="title">彩虹轨道</div>
      <div class="body">
        <div class="wrap-container">
          <div class="chart" id="rainbow"></div>
